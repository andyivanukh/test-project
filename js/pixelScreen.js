$(function(){
    ...
    var pxs_url = 'img/pixelperfect.png';
    var pxs_height = '800px';
    var pxs_opacity_control = true;

//===============================================================================================================================================================================================================

    $('body').append('<div class="screen" style="background:url('+pxs_url+') no-repeat center top; position: absolute; left: 5px; right: 0; top: 432px; height: '+pxs_height+'; z-index: 999999; pointer-events: none; display: none;"></div>')
